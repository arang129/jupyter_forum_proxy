# jupyter-forum-proxy : A Jupyter server proxy that enables Streamlit on top of JupyterLab/BinderHub
...
`sudoe -E pip install git+https://github.com/arang129/jupyter_forum_proxy.git`

`sudoe -E pip install --upgrade git+https://github.com/arang129/jupyter_forum_proxy.git`

`sudoe -E pip uninstall jupyter_forum_proxy`
